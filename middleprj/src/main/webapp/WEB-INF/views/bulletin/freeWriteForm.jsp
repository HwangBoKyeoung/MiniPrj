	...
	<section class="contact-section">
		<div class="container" style="margin-left: 30px">
			<div class="row">
				...
				<div class="col-lg-8">
					<form class="form-contact contact_form" action="freeWrite.do"
						method="post" id="frm">
						<div class="row">
							<div class="col-sm-6">
							...
							<div class="col-sm-6">
								<div class="form-group">
									<input class="form-control valid" name="freeDate"
										id="freeDate" type="date" onfocus="this.placeholder = ''"
							...
							<script>
								document.getElementById('freeDate').value = new Date()
										.toISOString().substring(0, 10);
							</script>
							<div class="col-12">
								<div class="form-group">
									<textarea class="form-control w-100" name="freeTitle"
										id="freeTitle" cols="3" rows="1"
							...
							<div class="col-12">
								<div class="form-group">
									<textarea class="form-control w-100" name="freeSubject"
										id="freeSubject" cols="30" rows="9"
										onfocus="this.placeholder = ''"
