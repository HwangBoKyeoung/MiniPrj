...
<form action="${pageContext.request.contextPath}/dealUpdate.do"
						...
						<div class="col-sm-6">
							<div class="form-group">
								<input class="form-control valid" name="dealWriter"
									id="dealWriter" value="${deal.dealWriter }" readonly="readonly"
						...
						<div class="col-sm-6">
							<div class="form-group">
								<input class="form-control valid" name="dealDate"
									id="dealDate" value="${deal.dealDate}"
						...
						<div class="col-12">
							<div class="form-group">
								<textarea class="form-control w-100" name="title"
									...
									onblur="this.placeholder = '제목'" placeholder="제목">${deal.dealTitle }</textarea>
							</div>
						</div>
						...
						<div class="col-12">
							<div class="form-group">
								<textarea class="form-control w-100" name="subject"
									...
									onfocus="this.placeholder = ''"
									onblur="this.placeholder = '내용'" placeholder="내용">${deal.dealSubject }</textarea>
							</div>
						</div>
					</div>
				</div>
